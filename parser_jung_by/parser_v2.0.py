...
def get_janga_prod():
    ...
    for i in range (8):
        i+=1
        with open(f"html/page_source_{i}_jung-a-creation.html") as file:
            src = file.read()
        ...
        for product in product_cards:
            ...
            with open(f"json/page_source_{i}_jung-a-creation.json", "w") as file:
...
def save_page_product():
    ...
    # url
    url = "https://jung-pro.ru/serii/jung-a-creation/"

    name_product = "jung-a-creation"
    for k in range(8):
        k += 1
        driver.get(url)
